...
!empty($data->shippingdate) && !empty($data->receiverdate)){    
    ...
    if($parcels->create()){         
        ...
        echo json_encode(array("message" => "Parcel was created successfully."));
    } else{         
        http_response_code(503);        
        echo json_encode(array("message" => "Unable to create parcel."));
    }
}else{    
    http_response_code(400);    
    echo json_encode(array("message" => "Unable to create parcel. Data is incomplete."));
}
?>